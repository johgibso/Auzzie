...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 306.0, 285.0, 73.0, 22.0 ],
					"text" : "loadmess 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 138.0, 285.0, 150.0, 147.0 ],
					"prototypename" : "pixl",
					"varname" : "tremr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 65.0, 425.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
,
					"text" : "Apply a tremolo (amplitude modulation) effect to a sound.",
					"textcolor" : [ 0.9, 0.9, 0.9, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.0, 459.0, 254.0, 87.0 ],
					"saved_attribute_attributes" : 					{
						"textcolor" : 						{
							"expression" : "themecolor.live_control_fg"
						}
...
,
					"text" : "rate - speed of modulation [hz]\n\nwaveform - pattern of modulation change: sine, triangle, square, saw up/down\n\ndepth - amount of tremolo",
					"textcolor" : [ 0.9, 0.9, 0.9, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 187.0, 244.0, 310.0, 39.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 109.0, 160.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 686.0, 132.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 319.5, 184.0, 51.0 ],
					"text" : "Adjust rate (frequency) of the oscillator and depth (amount) of the effect."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 138.0, 461.0, 71.0, 277.0 ],
					"prototypename" : "pixl",
					"varname" : "out",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 16.0, 146.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 357.0, 694.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 481.0, 335.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-1::obj-10" : [ "depth", "depth", 0 ],
			"obj-1::obj-13" : [ "rate[1]", "rate", 0 ],
			"obj-1::obj-15" : [ "LFOwave[2]", "LFOwave", 0 ],
