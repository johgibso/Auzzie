...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 138.0, 315.0, 144.0, 113.0 ],
					"prototypename" : "pixl",
					"varname" : "1delayr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Delay a sound by a certain amount of time. Mix that with the original undelayed sound. Apply feedback to create repetitions of the original sound that fade away.",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.0, 140.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 674.0, 132.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 285.0, 348.5, 169.0, 37.0 ],
					"text" : "Adjust delay time, feedback, and wet/dry mix."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 462.0, 357.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 352.0, 682.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textoncolor" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"name" : "az.sub-delay-simple-nogliss~.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/auzzie/patchers/sub",
				"patcherrelativepath" : "../patchers/sub",
				"type" : "JSON",
				"implicit" : 1
