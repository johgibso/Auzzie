...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 128.5, 166.0, 63.0, 22.0 ],
					"restore" : [ -6.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 480.0, 36.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 35.0, 81.0, 120.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 170.390380999999991, 352.0, 43.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 197.0, 51.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 148.390380999999991, 316.0, 63.0, 22.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
,
					"patching_rect" : [ 86.0, 378.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 166.0, 107.0, 22.0 ],
					"text" : "scale 0. 1. -70. 12."
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 86.0, 225.0, 47.0, 136.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.390380999999991, 471.0, 22.0, 43.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"hint" : "Data received in this inlet sets the value for the fader (0. - 1. | exact float (-70. - +12. dB)).",
					"id" : "obj-2",
					"ignoreclick" : 1,
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 323.0, 80.5, 15.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 3.0, 9.742592, 9.742592 ],
					"rounded" : 15.0,
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.75, 133.0, 71.0, 22.0 ],
					"text" : "clip -70. 12."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 206.0, 77.0, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					"comment" : "fader value (0. - 1. | exact float (-70. - +12 dB))",
					"id" : "obj-12",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.890380999999991, 480.0, 36.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 224.0, 36.0, 17.0 ],
					"text" : "Audio",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"fontname" : "Arial Bold",
					"fontsize" : 9.0,
					"hint" : "The AFADR module lets you control the volume of a stereo audio signal.",
					"id" : "obj-29",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 328.0, 503.201538000000028, 39.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 18.0, 42.0, 17.0 ],
					"text" : "AFADR",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.0, 471.0, 64.0, 64.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 471.0, 64.0, 64.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 471.0, 64.0, 64.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 224.0, 437.268768000000023, 35.433025000000001 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.25, 421.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 234.25, 208.0, 95.5, 208.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 215.5, 202.0, 95.5, 202.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"midpoints" : [ 44.5, 118.5, 95.5, 118.5 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1" : [ "textbutton[1]", "textbutton", 0 ],
