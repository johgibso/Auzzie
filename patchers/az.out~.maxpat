...
,
		...
		"enablevscroll" : 0,
		"devicewidth" : 0.0,
		"description" : "Output with volume control",
		"digest" : "",
		"tags" : "",
		"style" : "",
		"subpatcher_template" : "",
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 406.5, 116.0, 43.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.974807999999999, 196.0, 51.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 384.5, 75.0, 63.0, 22.0 ],
					"restore" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.5, 116.0, 101.0, 22.0 ],
					"text" : "scale 0. 1. -70. 6."
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.447569, 0.447569, 0.447569, 1.0 ],
					"color" : [ 0.17394, 0.649508, 0.936073, 1.0 ],
					"hint" : "Click the speaker to turn audio processing on and off.",
					"id" : "obj-6",
					"maxclass" : "mc.ezdac~",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 358.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 218.0, 51.0, 51.0 ]
				}

			}
, 			{
				"box" : 				{
					"hint" : "Sets the signal level for the total mix.",
					"id" : "obj-16",
					"lastchannelcount" : 1,
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 37.0, 158.0, 47.0, 136.0 ],
					"presentation" : 1,
...
,
					"showname" : 0,
					"tricolor" : [ 1.0, 1.0, 1.0, 0.701960784313725 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.75, 116.0, 66.0, 22.0 ],
					"text" : "clip -70. 6."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.390380999999991, 437.863524999999981, 22.0, 43.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 281.0, 23.0, 86.0, 33.0 ],
									"text" : "0: pass audio, \n1: mute"
								}
...
,
					"patching_rect" : [ 37.0, 324.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 37.0, 75.0, 120.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 57.0, 3.0, 9.742592, 9.742592 ],
					"rounded" : 15.0,
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					"fontname" : "Arial Bold",
					"fontsize" : 9.0,
					"hint" : "The OUT module lets you send your mix to the outside world. This is also where you turn audio processing on and off.",
					"id" : "obj-29",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 462.201538000000028, 44.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.474808, 18.0, 43.0, 17.0 ],
					"text" : "OUT",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 430.0, 64.0, 64.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.474808, 277.0, 270.268768000000023, 35.433025000000001 ],
					"proportion" : 0.39,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 240.0, 75.0, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					"comment" : "input fader (0. -1. | exact float (-70. - +6 dB))",
					"id" : "obj-76",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 17.0, 30.0, 30.0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-16" : [ "output", "output", 0 ],
			"obj-86" : [ "textbutton[1]", "textbutton", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
