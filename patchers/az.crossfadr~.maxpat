...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 42.006988999999997, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 158.0, 339.0, 84.0, 22.0 ],
					"text" : "az.sub-xfade~"
				}
...
, 			{
				"box" : 				{
					"fontname" : "Arial Bold",
					"fontsize" : 9.0,
					"hint" : "The CROSSFADR module lets you crossfade between two audio inputs.",
					"id" : "obj-83",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 367.0, 151.739990000000006, 94.0, 22.0 ],
					"restore" : [ 0.5 ],
...
, 			{
				"box" : 				{
					...
					"hint" : "Data received in this inlet sets the value for the crossfade dial (0. - 1.).",
					"id" : "obj-21",
					"ignoreclick" : 1,
