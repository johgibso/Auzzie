...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"hint" : "Sets the ring modulation frequency (in Hz).",
					"id" : "obj-10",
					"maxclass" : "live.dial",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 365.75, 262.576446999999973, 44.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"activedialcolor" : [ 0.184, 0.741, 0.0, 1.0 ],
					"activeneedlecolor" : [ 1.0, 1.0, 1.0, 0.7 ],
					"hint" : "Crossfades between the unaffected and ring-modulated audio.",
					"id" : "obj-5",
					"maxclass" : "live.dial",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 502.0, 262.576446999999973, 44.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 49.474808000000003, 40.792236000000003, 45.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"activedialcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 268.5, 371.007019000000128, 58.0, 22.0 ],
					"text" : "line~ 320"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.5, 339.0, 71.0, 22.0 ],
					"text" : "pack 0. 100"
				}
...
,
					"patching_rect" : [ 305.75, 140.0, 51.0, 22.0 ],
...
,
					"patching_rect" : [ 733.75, 173.006989000000004, 51.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 733.75, 124.006989000000004, 114.0, 47.0 ],
					"text" : "before I discovered exponent field of live.dial"
				}
...
,
					"patching_rect" : [ 733.75, 100.006989000000004, 65.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 247.5, 443.007019000000014, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 210.0, 481.007019000000014, 94.0, 22.0 ],
					"text" : "az.sub-xfade~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.5, 404.271027000000004, 68.0, 22.0 ],
					"text" : "cycle~ 320"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.75, 140.0, 89.0, 22.0 ],
					"text" : "clip 20. 20000."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 63.0, 252.0, 26.0, 20.0 ],
									"text" : "sig"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 31.0, 252.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 141.0, 530.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 522.0, 189.506989000000004, 73.0, 22.0 ],
					"restore" : [ 1.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 401.0, 189.506989000000004, 91.0, 22.0 ],
					"restore" : [ 319.999999999999943 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 84.0, 3.0, 9.742592, 9.742592 ],
					"rounded" : 15.0,
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
...
, 			{
				"box" : 				{
					"comment" : "ring modulation frequency (0. - 1. | exact float (20-20000 Hz))",
					"id" : "obj-11",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 141.0, 573.007019000000014, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.609558, 355.771027000000004, 41.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.474808, 18.0, 46.0, 17.0 ],
					"text" : "RINGR",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.474808, 16.0, 99.0, 19.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 1 ],
							"parameter_initial_enable" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 586.5, 130.007019000000014, 608.0, 130.007019000000014, 608.0, 85.007019, 624.0, 85.007019 ],
					"source" : [ "obj-19", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 511.5, 471.507019000000014, 294.5, 471.507019000000014 ],
					"source" : [ "obj-5", 0 ]
				}
